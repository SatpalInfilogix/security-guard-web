<div class="row mb-2">
    ...
    <fieldset class="col-md-12 mb-3">
        ...
        <div class="row mb-2">
            ...
            <div class="col-md-4 mb-3">
                <x-form-input name="company_name" value="{{ old('company_name', $user->guardAdditionalInformation->company_name ?? '') }}" label="Company Name" placeholder="Enter your Company Name"/>
            </div>
            <div class="col-md-4 mb-3">
                <x-form-input name="date_of_separation" value="{{ old('date_of_separation', $user->guardAdditionalInformation->date_of_seperation ?? '') }}" label="Date of Separation"  class="date_of_separation" placeholder="Enter your Date of Separation" type="text"/>
            </div>
        </div>
    </fieldset>
