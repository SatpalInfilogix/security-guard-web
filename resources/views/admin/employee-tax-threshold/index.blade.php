            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Employee Tax Threshold</h4>

                        <div class="page-title-right">
                            {{-- @can('create employee tax threshold') --}}
                                <a href="{{ route('employee-tax-threshold.create') }}" class="btn btn-primary">
                                            ...
                                            {{-- @canany(['edit employee tax threshold', 'delete employee tax threshold']) --}}
                                                <td class="action-buttons">
                                                    {{-- @can('edit employee tax threshold') --}}
                                                        <a href="{{ route('employee-tax-threshold.edit', $threshold->id) }}"
                                                    ...
                                                    {{-- @can('delete employee tax threshold') --}}
                                                        <button data-source="Tax Threshold"
                                                            data-endpoint="{{ route('employee-tax-threshold.destroy', $threshold->id) }}"
