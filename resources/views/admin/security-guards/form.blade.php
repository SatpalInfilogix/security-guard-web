    ...
    <div class="row mb-2">
        ...
        <div class="col-md-4 mb-3">
            <x-form-input name="date_of_seperation"
                value="{{ old('date_of_seperation', isset($user) && $user->guardAdditionalInformation ? \Carbon\Carbon::parse($user->guardAdditionalInformation->date_of_seperation)->format('d-m-Y') : '') }}"
