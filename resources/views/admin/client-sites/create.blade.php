        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Create a new Client Site</h4>

                        <div class="page-title-right">
                            <a href="{{ route('client-sites.index') }}" class="btn btn-primary"><i
                                    class="bx bx-arrow-back"></i> Back to Client Site</a>
                        </div>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('client-sites.store') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row mb-2">
                                ...
                                <div class="row mb-2">
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <select name="sr_manager_id" id="sr_manager_id" @class([
                                                'form-control',
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <x-form-input type="manager_email" name="email"
                                                value="{{ $clientSite->email ?? '' }}" label="Manager Email"
                                ...
                                <div id="client-operation-contact-container">
                                    ...
                                    <div class="row mb-2" id="client-operation-contact">
                                        <div class="col-md-4 mb-3">
                                            <x-form-input name="client_operation_name[]" value="" label="Name"
                                                placeholder="Enter name" />
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <x-form-input name="client_operation_position[]" value=""
                                                label="Position" placeholder="Enter position" />
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <x-form-input name="client_operation_email[]" value="" label="Email"
                                                placeholder="Enter email" />
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <x-form-input type="number" name="client_operation_telephone[]"
                                                value="" label="Telephone" placeholder="Enter telephone" />
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <x-form-input type="number" name="client_operation_mobile[]" value=""
                                                label="Mobile" placeholder="Enter mobile" />
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <button type="button" class="btn btn-primary mt-4"
                                                id="add-operation-contact">Add more contact</button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="client-account-contact-container">
                                    ...
                                    <div class="row mb-2" id="client-account-contact">
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <x-form-input name="client_account_name[]" value="" label="Name"
                                                    placeholder="Enter name" />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <x-form-input name="client_account_position[]" value=""
                                                    label="Position" placeholder="Enter position" />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <x-form-input name="client_account_email[]" value="" label="Email"
                                                    placeholder="Enter email" />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <x-form-input type="number" name="client_account_mobile[]"
                                                    value="" label="Mobile" placeholder="Enter mobile" />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <button type="button" class="btn btn-primary mt-4"
                                                id="add-account-contact">Add more contact</button>
                                        </div>
                                    </div>
                                </div>
